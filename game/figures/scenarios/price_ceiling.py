...
class PriceCeiling(Scenario):
    ...
    def injectors(self):
        return [
            ...
            Injector(
                ...
                self._deficit_rect,
                hint=u'дефицит — это разрыв по количеству, а потери общества — '
            ...
            Injector(
                ...
                hint=u'потери общества — ПОЛОВИНА произведения разрыва цен на '
                     u'изменение объёма'),
        ]
    ...
    def statement(self, params):
        ...
        return (
            ...
            u'(Q — %s, P — %s). Введено ограничение цены: %s — %s. Ученик '
