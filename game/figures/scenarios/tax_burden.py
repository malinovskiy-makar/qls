...
class TaxBurden(Scenario):
    ...
    def injectors(self):
        return [
            ...
            Injector(
                ...
                hint=u'потери общества — ПОЛОВИНА произведения ставки налога '
    ...
    def frame(self, params):
        return axis_max(params['q0']), axis_max(params['a'])
    ...
    def statement(self, params):
        ...
        return (
            ...
            u'(Q — %s, P — %s). Ставка составила %s руб. с единицы. Ученик '
    ...
    def explain(self, params, reference, injector):
        head = (
            ...
            u'продавца %s — они разные, потому что наклоны кривых разные. '
            u'Потери общества — треугольник: ½ · %s · %s = %s.' % (
                linear(params['a'], -params['b']),
                linear(params['c'], params['d']),
