  ...
  function drawFigure(fig) {
    ...
    (fig.points || []).forEach(function (p) {
      ...
      /* Выносы от 10 до 124 пикселей. Ближние предпочтительнее (штраф ri),
         ...
         тонкая выноска (с 62 пикселей) — так делают все нормальные
         рисователи графиков, и это честнее, чем оставить надпись поверх
         кривой. Без выноски отъехавшая подпись выглядит ничьей. */
