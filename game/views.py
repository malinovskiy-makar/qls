...
def _game_page_context(request):
    ...
    return {
        ...
        'config_json': dumps_for_script({
            ...
            'has_duel': HAS_DUEL,
            'min_playable': config.MIN_PLAYABLE,
            # Вошёл ли человек. Нужно правой карточке табло: анониму она
            # говорит «войдите, чтобы рекорды сохранялись», а вошедшему без
            # рекорда — «первый раунд в этом режиме». Два разных факта, и
            # выдуманного числа нет ни в одном.
