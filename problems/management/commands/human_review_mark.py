...
SUPERSEDES = {
    ...
    # Волна 1 починки: экран отвечает на вопрос «можно ли публиковать
    # СЕЙЧАС», поэтому исход «починил, идеально» отменяет прежний брак.
    'repair_aa_20260728': 'aa_20260728',
