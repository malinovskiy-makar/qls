...
им же на стоп-гейтах 08.09: два правила — обрубок и технический номер, оба
проверяются по тексту. Авторские клички и осмысленные заголовки любой длины
остаются, метка `title_source` в критерии не участвует. Правило отбора живёт в `problems/title_replacement.py`; здесь
