...
class OneTaskReviewTests(CheckBase):
    ...
    def test_the_comment_says_who_will_read_it(self):
        # ⚠️ Проверяем СМЫСЛ, а не знак препинания. Раньше здесь стояло
        # «— увидит только Пётр», и тест краснел, когда длинное тире ушло
        # из текстов сайта (правило владельца): подпись осталась на месте,
        # а тест ловил пунктуацию.
