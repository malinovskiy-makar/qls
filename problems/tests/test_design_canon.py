...
# ─────────────────────────────────────────────────────────────────────────────
CEILING = {
    # Замер сессии «храповик долга канона» 23.08.2026: manage.py test
    # problems.tests.test_design_canon -v 2 на чистом дереве ветки
    # feat/calc2-panel-night, до какой-либо правки экрана в этой сессии.
    ...
    "contrast_text": 4,            # было 28 → 4 к ночи 22.08 (см. решение выше), дальше не чистили
    "dark_white_on_accent": 14,    # было 20 → 14 к ночи 22.08, белый текст на акцентных инпутах в тёмной теме
    "title_on_interactive": 90,    # было 146 → 90 к ночи 22.08, нативный title вместо hint-pop/aria-label
}
