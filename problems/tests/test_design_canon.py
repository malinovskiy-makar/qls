...
# ─────────────────────────────────────────────────────────────────────────────
PENDING = {
    "hex_outside_tokens": "фаза 6 — канонный долг: одна шестнадцатеричная запись в calc2.css",
    "appearance_auto": "фаза 6 — панели: ползунок и число рисует система",
    "title_on_interactive": "фаза 5 (п. 33) и фаза 8 (п. 78–81) — своя система подсказок",
    "type_scale": "фаза 6 — панели: кегль и вес сводятся к шкале канона 1.2",
    "shadow_only_pop": "фаза 6 — канонный долг: тень у панелей и кнопок в покое",
    "touch_44": "фаза 6 — панели: высота нажимаемого пальцем",
}
...
NAMES = {
    ...
    "touch_44": "17. высота нажимаемого пальцем ≥ 44 px",
