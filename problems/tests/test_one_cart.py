...
class CreateScreensTests(TestCase):
    ...
    # ⚠️ Адрес разбора запроса из списка убран (визуальная сессия 17.08,
    # п. 2.1): по GET он больше не рисует страницу, а уводит в панель шага
    # «Что кладём» — то есть на первый адрес этого же списка, где имена
    # хранилищ и проверяются.
    URLS = ('/teacher/work/',
