...
class OlympiadRef(models.Model):
    ...
    match_method = models.CharField(
        ...
        choices=[
            ...
            # ⚠️ Два метода ниже НЕ сопоставляют со внешним индексом — они
            # разносят уже найденную привязку на текстовые копии задачи внутри
            # банка (команда find_olympiad_text_duplicates). Метаданные
