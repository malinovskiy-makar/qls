...
#
# ⚠️ У РАЗДЕЛА БОЛЬШЕ НЕТ СВОЕГО ЦВЕТА. До ADR 0038 каждому разделу
# полагался предметный цвет (ADR 0036), и здесь лежала пара значений на
# светлую и тёмную тему. Отказались: семь оттенков пестрят, а легенду
# человек не запоминает — цвет не вёл ни к какому действию. Раздел остался
# ЧИСТО СТРУКТУРНЫМ: он группирует список тем в правой панели и стягивает
# родственные темы в раскладке, и только. Все узлы карты рисуются одним
# нейтральным цветом `--map-node`.
GROUPS = (
    # ключ,     название,                   темы
