 ...
 *
 * ⚠️ Приблизительно: на боевой странице цвет ошибки — тот же #cc0000, который
 * теоретически может написать автор через \color{#cc0000}. Поэтому результат
 * этой функции — КАНДИДАТЫ; подтверждать их надо прогоном текста задачи через
 * песочницу (measureText), где сентинел снимает двусмысленность.
 */
