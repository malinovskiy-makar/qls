...
/* ⚠️ КАНОНИЧЕСКАЯ ЗАПИСЬ СТЕПЕНИ — НЕ ИСКАЖЕНИЕ НАБОРА. MathLive печатает
   «Q^3» как «Q^(3)»: то же самое число, та же формула, скобки его собственные.
   Строгое сравнение объявляло искажённым набор в четырнадцати полях сразу —
   и в прогоне 20.08, и здесь, — хотя набранное доезжало целым. */
