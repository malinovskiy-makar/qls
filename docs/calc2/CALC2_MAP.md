...
- строка 11 — `recompute`
- строка 470 — `recomputeOpenEconomy`
- строка 535 — `drawOpenAreas`
- строка 572 — `drawOpenLines`
- строка 619 — `attachOpenPwDrag`
- строка 627 — `setOpenPw`
- строка 637 — `setOpenTool`
- строка 649 — `updateOpenPanel`
- строка 685 — `drawEquilibrium`
- строка 722 — `drawOffQuadIntersection`
- строка 759 — `offQuadExplainHtml`
- строка 785 — `pctFormExplainHtml`
- строка 822 — `mathTspans`
- строка 862 — `hasMathMarkup`
- строка 886 — `markNotationTspan`
- строка 903 — `mixedNotationRe`
- строка 911 — `mixedMathTspans`
- строка 955 — `qtyTspans`
- строка 992 — `qtyGreekChar`
- строка 1030 — `texToCanvasText`
- строка 1039 — `renderLabelText`
- строка 1060 — `haloText`
- строка 1093 — `pointName`
- строка 1116 — `yWageLabel`
- строка 1121 — `yWageValue`
- строка 1144 — `isMonopolyScene`
- строка 1152 — `eqSectionTitle`
- строка 1168 — `updateEqSectionTitle`
- строка 1185 — `interventionKeyValues`
- строка 1236 — `countCrossings`
- строка 1245 — `updateInfoPanel`
- строка 1346 — `sumSceneOn`
- строка 1349 — `sumGroupsOf`
- строка 1356 — `sumGroupQty`
- строка 1369 — `sumChokePrice`
- строка 1395 — `sumPriceTop`
- строка 1416 — `sumLinearRecord`
- строка 1518 — `integrateBroken`
- строка 1529 — `curveBreaks`
- строка 1540 — `quadBreaks`
- строка 1556 — `sumSegExpr`
- строка 1574 — `sumPolyline`
- строка 1602 — `sumRebuildSide`
- строка 1653 — `sumSignature`
- строка 1673 — `sumRebuild`
- строка 1686 — `sumAnalyticsKey`
- строка 1704 — `sumGroupName`
- строка 1727 — `sumTagOf`
- строка 1734 — `sumShortTag`
- строка 1763 — `sumGroupColor`
- строка 1768 — `sumStartExpr`
- строка 1776 — `sumReorder`
- строка 1781 — `sumAddGroup`
- строка 1794 — `sumBuildScene`
- строка 1822 — `sumSetCount`
- строка 1841 — `syncSumUi`
- строка 1855 — `sumGroupStats`
- строка 1901 — `sumFinalRecords`
- строка 1919 — `updateSumPanel`
- строка 1980 — `drawAreas`
- строка 2008 — `beforeInterventionNote`
- строка 2017 — `updateAreasPanel`
- строка 2046 — `intervOnBuyer`
- строка 2055 — `drawShiftedSupply`
- строка 2107 — `taxPivotQ`
- строка 2138 — `taxPivotPoint`
- строка 2147 — `drawTaxPivot`
- строка 2182 — `drawTaxAreas`
- строка 2218 — `drawTaxPoints`
- строка 2271 — `attachTaxDrag`
- строка 2292 — `setTax`
- строка 2410 — `taxFormKey`
- строка 2418 — `pctForm`
- строка 2426 — `syncTaxKind`
- строка 2431 — `applyIntervCascade`
- строка 2497 — `setTaxForm`
- строка 2515 — `setType`
- строка 2563 — `rateLetter`
- строка 2567 — `rateUnit`
- строка 2582 — `unitRateMax`
- строка 2593 — `applyTaxRateBounds`
- строка 2628 — `syncQuotaHint`
- строка 2634 — `syncTaxHint`
- строка 2663 — `setTaxKind`
- строка 2669 — `updateTaxPanel`
- строка 2792 — `setTaxSide`
- строка 2803 — `setTaxSideButtons`
- строка 2816 — `drawElasticityZones`
- строка 2834 — `drawElasticityPoint`
- строка 2863 — `attachElastDrag`
- строка 2871 — `drawElasticityPointS`
- строка 2891 — `attachElastDragS`
- строка 2899 — `updateElasticityPanel`
- строка 2963 — `drawExtAreas`
- строка 2975 — `drawExtCurves`
- строка 2999 — `drawExtPoints`
- строка 3033 — `drawExtScenario`
- строка 3042 — `updateExtPanel`
- строка 3083 — `setExtSign`
- строка 3092 — `syncSocialFields`
- строка 3124 — `socialDefaultExpr`
- строка 3130 — `recompileSocial`
- строка 3152 — `setPRegFields`
- строка 3160 — `setPReg`
- строка 3169 — `drawPcAreas`
- строка 3193 — `drawPriceControl`
- строка 3242 — `attachPcDrag`
- строка 3251 — `updatePcPanel`
- строка 3296 — `setQuotaFields`
- строка 3307 — `setQuota`
- строка 3314 — `setQuotaPos`
- строка 3324 — `updateQuotaPriceLabel`
- строка 3336 — `drawQuotaAreas`
- строка 3363 — `drawQuotaLines`
- строка 3408 — `attachQuotaDrag`
- строка 3421 — `updateQuotaPanel`
- строка 3470 — `drawGhost`
...
- строка 392 — `monopolyQuota`
- строка 417 — `drawMonoQuotaAreas`
- строка 439 — `drawMonoQuotaPoints`
- строка 461 — `drawMonoQuotaLine`
- строка 487 — `naturalATC`
- строка 498 — `findRootLast`
- строка 513 — `recomputeNatural`
- строка 542 — `drawNaturalAreas`
- строка 557 — `drawNaturalCurves`
- строка 576 — `drawNaturalPoints`
- строка 605 — `drawNaturalFull`
- строка 613 — `updateNaturalPanel`
- строка 642 — `drawMonoTaxAreas`
- строка 665 — `drawMonoTaxShiftedMC`
- строка 680 — `drawMonoTaxPoints`
- строка 701 — `drawMonoFloorAreas`
- строка 716 — `drawMonoFloorPoints`
- строка 736 — `drawMonoFloorLine`
- строка 751 — `updateMonoInterventionPanel`
- строка 875 — `makeCurve`
- строка 884 — `drawDiscr1`
- строка 908 — `updateDiscr1Panel`
- строка 933 — `allocateMR`
- строка 946 — `recomputeDiscr3`
- строка 966 — `drawMiniMarket`
- строка 1053 — `redrawDiscr3`
- строка 1076 — `updateDiscr3Panel`
- строка 1123 — `applyD3WorldLabels`
- строка 1146 — `buildKinkedDemand`
- строка 1193 — `recomputeKinked`
- строка 1213 — `drawKinkedFull`
- строка 1257 — `updateKinkPanel`
- строка 1281 — `applyMonoVisibility`
- строка 1300 — `ensureMonopolyCurves`
- строка 1309 — `fillIfEmpty`
- строка 1312 — `ensureD3Fields`
- строка 1317 — `ensureKinkFields`
- строка 1323 — `ensureMonopolyPreset`
- строка 1330 — `setMonoMode`
- строка 1341 — `setKinkInput`
...
- строка 2170 — `detectSumKinks`
- строка 2188 — `drawPpfSumCurves`
- строка 2209 — `drawPpfSumMarks`
- строка 2235 — `updatePpfSumPanel`
- строка 2351 — `fmtRu`
- строка 2355 — `ppfSumSchemaData`
- строка 2389 — `schemaNote`
- строка 2396 — `drawPpfSumSchema`
- строка 2448 — `redrawPpfSum`
- строка 2461 — `setPpfSumView`
- строка 2472 — `cornerByValue`
- строка 2496 — `bestByValue`
- строка 2515 — `recomputePpfTrade`
- строка 2557 — `drawPpfTrade`
- строка 2582 — `drawPpfTradeMarks`
- строка 2610 — `updatePpfTradePanel`
- строка 2732 — `syncPpftPriceUI`
- строка 2743 — `redrawPpfTrade`
- строка 2764 — `recomputeTradeB`
- строка 2853 — `tradeCpfPoints`
- строка 2870 — `tradeBPanels`
- строка 2891 — `drawTradeB`
- строка 2956 — `drawTradeBMarks`
- строка 2959 — `tbName`
- строка 2965 — `updateTradeBPanel`
- строка 3035 — `syncTbPriceUI`
- строка 3048 — `redrawTradeB`
- строка 3063 — `setTradeScenario`
- строка 3075 — `setPpfSub`
...
- строка 206 — `redrawGraphMode`
- строка 217 — `renderMmRows`
- строка 258 — `graphRowsBox`
- строка 261 — `renderGraphRows`
- строка 279 — `graphError`
- строка 286 — `buildGraphRow`
- строка 368 — `equipGraphRows`
- строка 376 — `graphRowInput`
- строка 413 — `mainScales`
- строка 425 — `drawOverlays`
- строка 521 — `guardedPanelIds`
- строка 525 — `guardPanelBoxes`
- строка 561 — `panelsChangedSinceLastPass`
- строка 566 — `markPanelsChanged`
- строка 569 — `flushPendingPanelClears`
- строка 578 — `refreshAnalyticsPanel`
- строка 606 — `typesetStats`
- строка 653 — `addStatSign`
- строка 666 — `statToTex`
- строка 698 — `katexVisibleText`
- строка 704 — `restatWide`
- строка 744 — `statInkWidth`
- строка 752 — `statTooWide`
- строка 761 — `statPieces`
- строка 796 — `texAbbrev`
- строка 802 — `renderMathIn`
- строка 845 — `areaKey`
- строка 850 — `subDigits`
- строка 855 — `applyAreaColors`
- строка 865 — `currentAreas`
- строка 883 — `areaOfPathEl`
- строка 945 — `areaShort`
- строка 954 — `drawLegend`
- строка 1017 — `floatRects`
- строка 1034 — `legendCorner`
- строка 1111 — `viewWindow`
- строка 1123 — `axisWords`
- строка 1129 — `crossPoints`
- строка 1227 — `invalidateKeyTargets`
- строка 1230 — `kinksOf`
- строка 1278 — `keyTargets`
- строка 1395 — `snapVertexAt`
- строка 1429 — `drawCrossPoints`
- строка 1538 — `armCurve`
- строка 1544 — `disarmCurve`
- строка 1552 — `keyPointLit`
- строка 1565 — `drawCurveHits`
- строка 1599 — `pinKeyPoint`
- строка 1619 — `hoverLabel`
- строка 1630 — `drawRoller`
- строка 1651 — `rollerTargetAt`
- строка 1677 — `rollerClampX`
- строка 1696 — `rollerMove`
- строка 1712 — `showRollTip`
- строка 1735 — `hideRollTip`
- строка 1744 — `rollerOff`
- строка 1755 — `curveRightEdge`
- строка 1780 — `axisXLetter`
- строка 1790 — `axisLetter`
- строка 1803 — `armVerts`
- строка 1837 — `syncCanvasMode`
- строка 1857 — `leaveCanvasMode`
- строка 1862 — `addAreaVert`
- строка 1869 — `clearAreaVerts`
- строка 1875 — `renderVertList`
- строка 1941 — `syncAreaCalcButton`
- строка 1953 — `areaPickedCurve`
- строка 1962 — `areaCurveRange`
- строка 1980 — `syncAreaRangeLabel`
- строка 2016 — `freshenVertNames`
- строка 2032 — `drawAreaVerts`
- строка 2092 — `areaTargets`
- строка 2096 — `calcAreaUnderCurve`
- строка 2109 — `ringArea`
- строка 2119 — `segCross`
- строка 2126 — `ringSelfCrosses`
- строка 2148 — `angleRing`
- строка 2154 — `bestAreaRing`
- строка 2184 — `calcAreaPolygon`
- строка 2199 — `AREA_PALETTE`
- строка 2201 — `runAreaCalc`
- строка 2221 — `clearAreaCalc`
- строка 2228 — `drawAreaCalc`
- строка 2257 — `updateAreaCalcPanel`
- строка 2355 — `syncAreaCalcUI`
- строка 2390 — `updateQuickArea`
- строка 2392 — `setAreaCalcMode`
- строка 2408 — `wireFolds`
- строка 2433 — `wireAreaCalc`
- строка 2462 — `paramsAllowed`
- строка 2487 — `isReservedName`
- строка 2527 — `expandImplicitMul`
- строка 2573 — `visibleSvgText`
- строка 2599 — `chartLabelSource`
- строка 2609 — `chartLabelBase`
- строка 2626 — `chartLabelKind`
- строка 2640 — `typesetChartLabels`
- строка 2668 — `prepExpr`
- строка 2686 — `texToPlain`
- строка 2712 — `sceneReservedKey`
- строка 2716 — `freeSymbols`
- строка 2734 — `freeSymbolsUncached`
- строка 2762 — `sceneReserved`
- строка 2785 — `sceneExtraParams`
- строка 2791 — `paramValue`
- строка 2797 — `paramScope`
- строка 2807 — `scopeFor`
- строка 2814 — `evalWithParams`
- строка 2825 — `syncParams`
- строка 2881 — `buildParamChip`
- строка 3004 — `initSceneColorPickers`
- строка 3016 — `syncSceneColorPickers`
- строка 3024 — `syncAxisPlaceholders`
- строка 3039 — `titleAnchorPx`
- строка 3049 — `drawGraphTitle`
- строка 3088 — `editGraphTitleOnCanvas`
- строка 3133 — `normHex`
- строка 3155 — `paletteSix`
- строка 3163 — `closeColorMenu`
- строка 3177 — `onDocClosePick`
- строка 3181 — `onEscClosePick`
- строка 3188 — `makeColorPicker`
- строка 3275 — `autoCurveName`
- строка 3284 — `curveShortName`
- строка 3294 — `markCaption`
- строка 3303 — `drawMarks`
- строка 3390 — `snapTargets`
- строка 3476 — `macroSnapTargets`
- строка 3495 — `consumerSnapTargets`
- строка 3524 — `ineqSnapTargets`
- строка 3538 — `mathSnapTargets`
- строка 3590 — `tradeSnapTargets`
- строка 3610 — `axisSnapAt`
- строка 3629 — `snapDistPx`
- строка 3648 — `snapPointAt`
- строка 3689 — `showSnapHint`
- строка 3708 — `armMark`
- строка 3721 — `cancelMarkDraft`
- строка 3761 — `resetDecor`
- строка 3852 — `_undoCopyChild`
- строка 3866 — `_undoCopy`
- строка 3880 — `pushUndo`
- строка 3890 — `undoLast`
- строка 3906 — `clearUndo`
- строка 3913 — `forgetSceneSnapshot`
- строка 3915 — `resetSceneMemory`
- строка 3917 — `saveSceneSnapshot`
- строка 3926 — `restoreSceneSnapshot`
- строка 3945 — `addMarkAt`
- строка 3980 — `colorDist`
- строка 3989 — `drawnStrokeColors`
- строка 4005 — `nextMarkColor`
- строка 4021 — `newMark`
- строка 4033 — `pendingMark`
- строка 4036 — `startMarkDraft`
- строка 4045 — `markSnapFn`
- строка 4055 — `renderMarkList`
- строка 4068 — `ensureAddMarkButton`
- строка 4078 — `buildMarkRow`
...
- строка 67 — `pultRegulatorIds`
- строка 164 — `pultCurveList`
- строка 175 — `pultExtraSig`
- строка 181 — `pultExtraSigBase`
- строка 193 — `pultShouldShow`
- строка 203 — `shiftChipLabel`
- строка 217 — `curveChipLabel`
- строка 226 — `pultCurveSig`
- строка 236 — `paintEqLabel`
- строка 251 — `texifyName`
- строка 273 — `editEqValue`
- строка 332 — `centerBandOn`
- строка 336 — `pullIntoBand`
- строка 340 — `attachBoundsEditor`
- строка 422 — `refreshRegulators`
- строка 433 — `makePchip`
- строка 461 — `curveShiftBase`
- строка 468 — `buildPultCurveChips`
- строка 551 — `syncPultCurveValues`
- строка 576 — `capturePultHome`
- строка 583 — `capturePultHomes`
- строка 588 — `returnPultHome`
- строка 600 — `syncPultRegulators`
- строка 625 — `upgradeRegulator`
- строка 785 — `shortRegulatorName`
- строка 805 — `ppfLinearFormula`
- строка 811 — `ppfInterceptsOf`
- строка 819 — `ppfSetSingle`
- строка 827 — `ppfSetSum`
- строка 844 — `addPultXChip`
- строка 855 — `buildPultExtra`
- строка 887 — `ineqParseIncomes`
- строка 890 — `ineqMasterRebase`
- строка 895 — `ineqMasterScale`
- строка 913 — `ineqMasterApply`
- строка 925 — `ineqMasterDetach`
- строка 930 — `buildIneqMasterChip`
- строка 938 — `showPult`
- строка 965 — `updatePult`
- строка 985 — `wireControls`
