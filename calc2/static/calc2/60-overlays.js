...
function legendCorner(boxW, boxH) {
  ...
  /* Б47. Углы только ПРАВЫЕ. Слева у графика ось значений с цифрами делений и
     подписями величин, и легенда, севшая туда, всякий раз спорит с ними, даже
     когда кривых в том углу нет. Механизм выбора прежний: из двух правых
     берётся тот, где меньше занято. */
  const corners = [
