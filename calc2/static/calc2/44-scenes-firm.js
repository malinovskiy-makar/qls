...
function updatePlantsPanel() {
  ...
  html += '<div class="hint" style="margin-top:8px;padding-top:8px;border-top:.5px solid var(--border);">' +
    ...
    'Пока MC₁&nbsp;≠&nbsp;MC₂, единицу выгодно перебросить с дорогого завода на дешёвый, значит в оптимуме ' +
    '<b>MC₁&nbsp;=&nbsp;MC₂&nbsp;=&nbsp;MC(Q)</b>. Поэтому совокупную кривую строят так: фиксируют уровень ' +
