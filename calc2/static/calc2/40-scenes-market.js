...
function updateElasticityPanel() {
  ...
  if (s && !isNaN(s.Es)) {
    ...
    html += '<div class="hint">Прямое предложение через начало координат даёт |Es|&nbsp;=&nbsp;1 в любой точке; ' +
      'с положительным перехватом цены неэластично, с отрицательным эластично.</div>';
