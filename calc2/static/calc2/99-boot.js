...
function init() {
  ...
  /* 01.09. Те же два списка, что оставались системными коробочками ОС и
     выбивались из оформления: деформация графика и число групп неравенства.
     Нового компонента не заводим — тот же upgradeSelect поверх того же
     select, и сцены о подмене по-прежнему ничего не знают. */
  upgradeSelect('math-trans', 'Что делаем с графиком');
  upgradeSelect('ineq-ngroups', 'Сколько групп населения');
