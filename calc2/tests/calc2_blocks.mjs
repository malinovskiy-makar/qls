...
// 15 → 14: карточка «Автаркия» удалена 01.09 (решение владельца). Число здесь
// стоит храповиком против случайного возврата обещаний в окно выбора.
await t('карточек «скоро» ровно 14', async () =>
  (await page.locator('.scard.soon').count()) === 14 || 'их ' + (await page.locator('.scard.soon').count()));
